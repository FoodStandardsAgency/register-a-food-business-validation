...
describe("Function: validatePartners", () => {
  ...
  it("Should return false if array length is above 5", () => {
    //Arrange
    const badPartnersLength = ["jon", "Mike", "jo", "dan", "wes", "exa"];
    //Act
  ...
  it("Should return true when the array length is between 2-5", () => {
    //Arrange
    const goodPartnersLength = ["jon", "Mike", "jo", "dan"];
    //Act
  ...
  it("Should return true when the array length is exactly 5", () => {
    //Arrange
    const goodPartnersLength = ["jon", "Mike", "jo", "dan", "exa"];
    //Act
    const valid = validatePartners(goodPartnersLength);
    //Assert
    expect(valid).toBe(true);
  ...
  it("Should return false if consecutive values in array are duplicated", () => {
    ...
    //Act
    const valid = validatePartners(duplicatesPartnersArray);
    //Assert
    expect(valid).toBe(false);
  });
  ...
  it("Should return true if array has no duplicate values", () => {
    ...
    //Act
    const valid = validatePartners(validPartnersArray);
    //Assert
    expect(valid).toBe(true);
  });
});
